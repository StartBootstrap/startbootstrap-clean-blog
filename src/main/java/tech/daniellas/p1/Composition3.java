...
class Composition3 {
	...
	// Function appending given value with given suffix
	static <A> String append(String suffix, A value) {
		return value + suffix;
	}
	
	// Create partially applied function with suffix ' %'
	static Function<BigDecimal, String> percentAppender = partial(Composition3::append, " %");
