package tech.daniellas.streams.parallel;
...
public class ParallelDoubleCalculationBenchmark extends ParallelFastBenchmarkBase {

	// This if our calculation, takes Double type number, calculates logarithm,
	// then
	...
	protected String reportPath() {
		return "data/benchmark-streams-sum-double-calculation-parallel.json";
	}
