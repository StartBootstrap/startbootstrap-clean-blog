...
public class ParallelDoubleCalculationCollectBenchmark extends BenchmarkBase {
	...
	protected String reportPath() {
		return "data/benchmark-threads-streams-sum-double-calculation-parallel-collect.json";
	}
